...
export const Route = createFileRoute("/_authenticated/settings/whatsapp")({
  head: () => ({
    meta: [
      { title: "WhatsApp Integration — UMRAIO AI Sales Executive" },
      {
        name: "description",
        content:
          "Connect your WhatsApp Business number so the UMRAIO AI Sales Executive answers Umrah enquiries automatically.",
      },
          ...
          <section className="panel space-y-4 p-5">
            ...
            <div className="flex items-center justify-between rounded-xl border border-border bg-surface px-4 py-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Let the AI Sales Executive answer inbound WhatsApp messages automatically.
                </p>
              </div>
              <Switch
